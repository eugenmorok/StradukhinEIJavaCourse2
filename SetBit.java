...
public class SetBit {
    ...
    public static void main(String[] args) {
        ...
        //there are number overflow at index 31
        /*else if (income_index == 31) {
            long templateL = 1;
            long income_numberL = (long)income_number;
            long new_templateL = templateL << income_index;
            long print_numberL = income_numberL ^ new_templateL;
            System.out.println(print_numberL);
        }*/
