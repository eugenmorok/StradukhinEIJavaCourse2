...
public class ResetBit_Wrong {

    public static void main(String[] args) {

        Scanner scan = new Scanner(System.in);
        int template = -1;
        System.out.println("Good day, The program sets a specific int-bit that the user specifies (from 0 to 31)  to \"zero\".");
        ...
        if (income_index >= 0 & income_index < 32) {
            ...
            int print_number = (income_number & new_template) - 1;
